package com.growwithme.iam.infrastructure.authorization.sfs.configuration;

import com.growwithme.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.growwithme.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.growwithme.iam.infrastructure.tokens.jwt.BearerTokenService;
    ...
    http.csrf(csrfConfigurer -> csrfConfigurer.disable())
        ...
        .authorizeHttpRequests(
            authorizeRequests -> authorizeRequests.requestMatchers(
                ...
                "/swagger-ui/**", "/swagger-resources/**", "/webjars/**", "/api/v1/devices/**")
                .permitAll()
                .anyRequest()
                .authenticated());
