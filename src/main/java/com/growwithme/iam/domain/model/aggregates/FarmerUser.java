...
public class FarmerUser extends User {
    ...
    public FarmerUser(String email, String password, String firstName, String lastName, String phone, String photoUrl, String dni) {
        super(email, password, firstName, lastName, phone, photoUrl, dni);
    }

    public FarmerUser(String email, String password, String firstName, String lastName, String phone, String photoUrl, String dni, List<Role> roles) {
