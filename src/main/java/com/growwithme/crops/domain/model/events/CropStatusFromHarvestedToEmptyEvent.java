...
@Getter
public class CropStatusFromHarvestedToEmptyEvent extends ApplicationEvent {
    private Long cropId;
    private CropStatus oldCropStatus;
    private CropStatus newCropStatus;

    public CropStatusFromHarvestedToEmptyEvent(Object source, Long cropId, CropStatus oldCropStatus, CropStatus newCropStatus) {
        super(source);
        this.cropId = cropId;
