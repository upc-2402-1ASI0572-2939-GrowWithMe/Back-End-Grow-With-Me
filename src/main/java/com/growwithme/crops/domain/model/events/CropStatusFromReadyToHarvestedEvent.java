...
@Getter
public class CropStatusFromReadyToHarvestedEvent extends ApplicationEvent {
    private Long cropId;
    private CropStatus oldCropStatus;
    private CropStatus newCropStatus;

    public CropStatusFromReadyToHarvestedEvent(Object source, Long cropId, CropStatus oldCropStatus, CropStatus newCropStatus) {
        super(source);
        this.cropId = cropId;
