...
@Getter
public class CropStatusFromEmptyToPlantedEvent extends ApplicationEvent {
    private Long cropId;
    private CropStatus oldCropStatus;
    private CropStatus newCropStatus;

    public CropStatusFromEmptyToPlantedEvent(Object source, Long cropId, CropStatus oldCropStatus, CropStatus newCropStatus) {
        super(source);
        this.cropId = cropId;
